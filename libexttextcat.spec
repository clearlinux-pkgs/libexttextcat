...
Version  : 3.4.7
Release  : 5
URL      : https://github.com/LibreOffice/libexttextcat/archive/v3.4.7/libexttextcat-3.4.7.tar.gz
Source0  : https://github.com/LibreOffice/libexttextcat/archive/v3.4.7/libexttextcat-3.4.7.tar.gz
...
%package data
Summary: data components for the libexttextcat package.
Group: Data

%description data
data components for the libexttextcat package.
...
%package license
Summary: license components for the libexttextcat package.
Group: Default

%description license
license components for the libexttextcat package.


%prep
%setup -q -n libexttextcat-3.4.7
cd %{_builddir}/libexttextcat-3.4.7
pushd ..
cp -a libexttextcat-3.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704224939
...
cp %{_builddir}/libexttextcat-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/libexttextcat/9423a0052858d160a2b385516ba972e1ba83e468 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
/usr/share/libexttextcat/fkv.lm
...
/usr/share/libexttextcat/ilo.lm
...
/usr/share/libexttextcat/koi.lm
...
/usr/share/libexttextcat/lij.lm
/usr/share/libexttextcat/lld.lm
...
/usr/share/libexttextcat/nio.lm
...
/usr/share/libexttextcat/pap.lm
...
/usr/share/libexttextcat/sun.lm
...
/usr/share/libexttextcat/vec.lm
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexttextcat-2.0.so.0.0.0
/usr/lib64/libexttextcat-2.0.so.0
